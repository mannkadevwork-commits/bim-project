      ...
      <div className="relative w-full max-w-3xl overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950/95 shadow-2xl">
        ...
        <div className="relative p-8 sm:p-10">
          <div className="flex items-start justify-between gap-6">
            <div>
              <p className="text-xs font-bold tracking-[0.24em] uppercase text-cyan-400">HC Interior BIM</p>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <button
              ...
              onClick={onStartNew}
              disabled={isContinuing}
              className="group rounded-2xl border border-slate-700 bg-slate-900/70 p-6 text-left transition-all hover:-translate-y-0.5 hover:border-indigo-400/50 hover:bg-indigo-500/5 disabled:cursor-not-allowed disabled:opacity-70"
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-500/10 text-indigo-300">
                  <Plus className="h-6 w-6" />
                </div>
                <ArrowRight className="h-5 w-5 text-slate-500 transition-transform group-hover:translate-x-1 group-hover:text-indigo-300" />
              </div>
